...
class baca7 extends StatefulWidget {
  @override
  _baca7State createState() => _baca7State();
}

class _baca7State extends State<baca7> {
  @override
...
class _HomeState extends State<Home> {
  ...
  upd() async {
    DatabaseReference ref1 = FirebaseDatabase.instance.ref("Group7/$k");
