...
class crud1_update extends StatefulWidget {
  @override
  _crud1_updateState createState() => _crud1_updateState();
}

class _crud1_updateState extends State<crud1_update> {
...
//   }
  ...
  void updateData(
      String key, String nama, String nim, String email, String matakuliah) {
        ...
        child: ListView(
          children: [
            TextField(
              ...
              decoration: InputDecoration(labelText: 'Nomor Data'),
            ),
            TextField(
