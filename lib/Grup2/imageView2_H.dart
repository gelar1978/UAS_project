...
class ImageView_H extends StatefulWidget {
  static final String title = 'Firebase Download';

  @override
  State<ImageView_H> createState() => _ImageView_HState();
}

class _ImageView_HState extends State<ImageView_H> {
  ...
  void initState() {
    ...
    futureFiles = FirebaseStorage.instance.ref('/Grup2/CitraH').listAll();
  }
  ...
  Widget build(BuildContext context) => MaterialApp(
      ...
      title: ImageView_H.title,
      theme: ThemeData(primarySwatch: Colors.blue),
      home: Scaffold(
        appBar: AppBar(
          title: Text(ImageView_H.title),
          centerTitle: true,
          actions: <Widget>[
            IconButton(
              icon: const Icon(
